...
- [From Manual Run to Automation](manual-to-automation.md)
- [Research, Plan, Execute, Review, Ship](../templates/workbuddy-context/research-plan-execute-review-ship.md)
